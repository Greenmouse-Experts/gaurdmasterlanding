          ...
          <div className="box h-full flex items-center justify-center">
            <div className="lg:w-[550px] mx-auto bg-white lg:px-16 p-6">
              ...
              <div className="my-8 lg:mt-16 mb-5 mx-auto">
                ...
                {isSuccess && (
                  <div>
                    <img src={'https://res.cloudinary.com/greenmouse-tech/image/upload/v1705925994/rsh/check-mark_vhbeuv.png'} alt="check" className="w-6/12 mx-auto" />
                ...
                {isError && (
                  <div>
                    <img src={'https://res.cloudinary.com/greenmouse-tech/image/upload/v1705929170/rsh/failed_zbvdtm.gif'} alt="check" className="w-4/12 mx-auto" />
