...
const Partnership = () => {
  return (
    <>
      ...
      <Header image={'https://res.cloudinary.com/greenmouse-tech/image/upload/v1706182936/GuardMaster/Group_48097434_1_j5kis8.png'} title="Industry Partnerships" body="Industry Partnerships" />
      <div>
        <div className='boxes'>
          <div className='py-12'>
